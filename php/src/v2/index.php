                        ...
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="counter/checklogin" method="POST" class="row g-3 needs-validation"
                                        novalidate>

                                        <div class="col-12">
                                            <label for="co_username" class="form-label">ຊື່ເຂົ້າລະບົບ</label>
                                        ...
                                        <div class="col-12 mb-3">
                                            <label for="co_password" class="form-label">ລະຫັດ</label>
                                            <input type="password" name="co_password" class="form-control" required>
