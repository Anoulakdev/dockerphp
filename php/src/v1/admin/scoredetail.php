                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-end">
                                    ...
                                    <a href="excelscoredetail" type="button" class="btn btn-success my-3" target="_blank">
                                        <i class="bi bi-filetype-xlsx"></i> EXCEL </a>
                                </div>


                                <?php
                                $query = "SELECT sc.*, m.*, c.*  FROM score as sc inner join member as m on sc.m_id = m.m_id inner join candidate as c on sc.c_id = c.c_id WHERE sc.sc_result = 0 order by sc.m_id ASC";
