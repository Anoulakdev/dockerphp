                                        ...
                                        <tbody>
                                            ...
                                            <?php for ($i = 0; $i < count($obj); $i++) { ?>
                                                <tr>
                                                    ...
                                                    <td><?= $obj[$i]->m_part; ?></td>
                                                    <td>
                                                        <a data-id="<?= $obj[$i]->m_id; ?>" href="s_action?deleteall=<?= $obj[$i]->m_id; ?>" type="button" class="btn btn-danger delete-btn"><i class="bi bi-trash"></i></a>
                                                    </td>
                                                </tr>
